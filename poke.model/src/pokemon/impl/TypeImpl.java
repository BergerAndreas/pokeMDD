...
public class TypeImpl extends MinimalEObjectImpl.Container implements Type {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PokemonPackage.TYPE__NAME, oldName, name));
	}
	...
	public EList<Pokemon> getPokemon() {
		if (pokemon == null) {
			pokemon = new EObjectWithInverseResolvingEList.ManyInverse<Pokemon>(Pokemon.class, this, PokemonPackage.TYPE__POKEMON, PokemonPackage.POKEMON__TYPE);
		}
		return pokemon;
	}
